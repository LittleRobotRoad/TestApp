...
import com.ycgwl.carrier.app.Constants;
...
public class TakePhotoUtils {
    ...
    public static List<String> saveBitmapFileList(List<String> path, int width, int height) {
        ...
        for (int i = 0; i < path.size(); i++) {
            paths.add(saveBitmapFile(path.get(i), width, height));
        }
        return paths;
    }
    ...
    public static String saveBitmapFile(String path, int width, int height) {
        ...
        String save_path = Environment.getExternalStorageDirectory().getPath() + Constants.PHOTO_PATH + "abc" + System.currentTimeMillis() + ".jpg";
    ...
    public static void setDownloadPath() {
        String save_path_parent = Environment.getExternalStorageDirectory().getPath() + Constants.PHOTO_PATH;
