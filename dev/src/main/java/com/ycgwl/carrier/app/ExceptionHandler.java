...
import com.ycgwl.carrier.util.TextUtils;
...
//				ToastUtil.show_long(context, "很抱歉,程序出现异常,即将退出");
    ...
    private String saveErrorInfotoFile(Throwable ex) {
        ...
        try {
            ...
            String fileName = "exception_" + time + ".log";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory().getAbsolutePath() + errorPath;
